...
<div class="small-container">
    ...
    <div class="row row-2">
        <h2>All Products</h2>
        <form action="sortPrice" method="get">
            <select name="" id="">
    ...
    <div class="row">
        <%
            ...
            while (true) {
                ...
                String imageName = (String) request.getAttribute(imageAttribute);

                if (productName == null || price == null || imageName == null) {
                    break;
                }
        %>
        <div class="col-4">
            <img src="productImages/<%= imageName %>" alt="">
